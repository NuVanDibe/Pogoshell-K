...
For a mostly complete to theming, look here: [Unofficial Pogoshell Theming](https://github.com/NuVanDibe/Pogoshell-K/blob/main/theming.md). If the information provided is still not helpful, feel free to look at the theme(s) available for my unofficial Pogoshell fork. They may be helpful.
